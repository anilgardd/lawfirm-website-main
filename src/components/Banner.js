      ...
      <div className="container mx-auto h-full lg:flex pt-32">
        <div className="text-center mx-auto h-full lg:text-left px-8 md:p-0">
          <h1 className="font-primary font-black text-6xl lg:text-7xl text-primary mb-4 lg:mt-[70px] leading-tight lg:leading-[90px]">
            SORUNLARINIZ <br /> <span className="text-accent">Hedefimiz</span>
          </h1>
          <p className="max-w-sm mx-auto mb-[50px] lg:mx-0 lg:max-w-[540px]">
            Adaletin herkese eşit şekilde ulaşması için mücadele ediyoruz.
            Sadece kazanmak değil, adaletin gerçek anlamda sağlanması ve hukuki
            süreçlerin adil bir şekilde yürütülmesi için çalışıyoruz. Hukuki
            bilinci artırmak ve bireylerin haklarını ve sorumluluklarını
            anlamalarına yardımcı olmak amacıyla toplumda farkındalık oluşturma
